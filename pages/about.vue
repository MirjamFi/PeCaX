	...
	export default{
	  ...
	  head () {
	    return {
	    	link: [
	        {
	        	rel:"stylesheet", type:"text/css", href:"subgraphCss.css"
	        },
	        {
	        	rel:"alternate", type:"application/html", title:"CPeCaX", href:"/"
	        }
	      ]
	    }
	  }
