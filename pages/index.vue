<template>
  	<v-layout justify-center align-center width=90%>
    	<v-flex>
    		...
    		<div class="row">
    			<!-- <v-card text class="rounded-card"  style="background-color:#EDF1FF" > -->
		    		<div style="width: 30%; margin-left: 5%">
		 				<img src="/landingpage_image.svg" style="margin: auto;">
		 			</div>
		 		<!-- </v-card> -->
	    		<div style="margin-bottom: 20px; padding-bottom: 10px; padding-top:5%;font-size: 20px; font-weight: 500; width: 59%; margin-right: 5%">
	    			<v-card text class="rounded-card"  style="background-color:#EDF1FF" >
