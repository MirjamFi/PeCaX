<template>
  	<v-layout justify-center align-center width=90%>
    	<v-flex xs12 sm8 md12>
    		<div class="row">
    		<div class="column">
 				<img src="/landingpage_image.png" style="margin-bottom: 5vh; margin-top: 5vh">
 			</div>
    		<div class="column" style="margin-bottom: 20px; padding-bottom: 10px; font-size: 16px; font-weight: 500">
